...
table2
saveRDS(table2, file = (here("results", "statistical_analysis_result", "full_model.rds")))
```
...
table3 <- tidy(log_fit_age_hispanic)
saveRDS(table3, file = (here("results", "statistical_analysis_result", "age_hispanic_model.rds")))
```
...
saveRDS(table4, file = (here("results", "statistical_analysis_result", "demographic_model.rds")))
```
...
saveRDS(table5, file = (here("results", "statistical_analysis_result", "medical_model.rds")))
```
...
saveRDS(table6, file = (here("results", "statistical_analysis_result", "smoking_alcohol_model.rds")))
```
