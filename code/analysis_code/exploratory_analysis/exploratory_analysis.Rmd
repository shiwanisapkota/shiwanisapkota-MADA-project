...
figure1 <- ggplot(data = data_clean_main1, aes(x = mammogram_status)) +
...
figure1_optional<- ggplot(data_clean_main1, aes(x = mammogram_status))+
...
# Saving this figure
ggsave(filename = here("results","exploratory_analysis_result", "figure1optional_mammogram_ses.png"), plot = figure1_optional)
```
