...
```{r, message = FALSE}
#| echo: FALSE
 # Loading coefficients table using mammogram status as the outcome and other variables of interests as the predictors using model evaluation
result_table20 <- readRDS(here("results", "statistical_analysis_result", "2_model_evaluation_result", "logistic_full_model.rds"))
result_table20
```
...
```{r, message = FALSE}
#| echo: FALSE
 # Loading coefficients table using mammogram status as the outcome and hispanic status as the main predictor using model evaluation
result_table21 <- readRDS(here("results", "statistical_analysis_result", "2_model_evaluation_result", "logistic_outcome_mainpredictor.rds"))
result_table21
```
...
```{r, message = FALSE}
#| echo: FALSE
 # Loading coefficients and penalty data during lasso model process
result_table22 <- readRDS(here("results", "statistical_analysis_result", "3_machine_learning_result", "lasso_model_final_fit.rds"))
result_table22
```
