...
The study was limited within 40-74 years Hispanic and non-Hispanic women with no report of cancer during the years 2000, 2005, 2010, and 2015. Exclusion of missing data points in 1 or more predictor variables yielded a final sample of 24848 subjects. 

[** Statistical analysis part to be added]
...
result_table2 <- readRDS(here("results", "statistical_analysis_result", "1_model_fitting_result", "model_performance_comparison.rds"))
print(result_table2)
```
...
**Table 4: Model Selection using Null, Decision tree and Lasso methods.**
