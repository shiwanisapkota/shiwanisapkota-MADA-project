...
**Table 3: Full model fitting using mammogram_status as outcome variable and other variables as predictor variables.**
```{r, warning = FALSE, message = FALSE}
#| echo: FALSE
...
# Loading the `figure2_roc_fullmodel.png` figure which was created during the model evaluation process
include_graphics(here("results", "statistical_analysis_result", "2_model_evaluation_result", "figure2_roc_fullmodel.png"))
```
**Figure 2: ROC Curve for the full model**

```{r}
#| label: Figure 3
#| fig-cap: "ROC Curve for the alternative model."
#| echo: FALSE

# Loading the `figure3_roc_altmodel.png` figure which was created during the model evaluation process
include_graphics(here("results", "statistical_analysis_result", "2_model_evaluation_result", "figure3_roc_altmodel.png"))
```
**Figure 3: ROC Curve for the alternative model**
...
result_table3 <- readRDS(here("results", "statistical_analysis_result", "3_machine_learning_result", "machinelearning_results.rds"))
print(result_table3)
```
